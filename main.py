...
def main():
    # 加载人脸检测联级文件
    face_detect = cv2.CascadeClassifier('D:\python_object\haarcascade_frontalface_default.xml')

    # 加载眼部检测联级文件
    eye_detect = cv2.CascadeClassifier('D:\python_object\haarcascade_eye.xml')
